...
export function CollaboraSection() {
  return (
    <section className="flex w-full flex-row gap-8 justify-center min-[1616px]:justify-start px-6 min-[1616px]:px-36">
      <div className="flex max-w-[959] flex-col gap-6">
        <h2 className="typo-headline-medium text-center md:typo-display-medium min-[1616px]:text-start">Vuoi sviluppare un progetto insieme a noi?</h2>

        <div className="flex flex-col gap-3 min-w-0 text-center md:text-start">
          <p className="typo-body-large text-center md:typo-headline-small min-[1616px]:text-start">
