...
import {
  getAlignmentClasses,
  getCardPaddingClasses,
  getContentGapClasses,
  getTitleSizeClasses,
} from "./utils";
...
export function CardIcon(props: CardIconProps) {
  ...
  const { contentClass, textClass, iconWrapClass } = getAlignmentClasses(
    align,
    isDescriptionCard,
  );
      ...
      >
        ...
        {iconOnly ? (
          ...
          <div className="relative z-10 flex flex-col gap-2">
            ...
            {description && (
              <p className="typo-body-large text-left text-text-primary">
                {description}
              </p>
            )}
          </div>
              ...
              {description && (
                <p
                  className={cn(
                    ...
                    isCompactDescriptionCard
                      ? "typo-body-large max-w-60"
                      : "typo-body-medium max-w-sm",
                  )}
                >
                  {description}
                </p>
