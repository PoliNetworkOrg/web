...
export function CardGroups({
  ...
  return (
    <Card className="typo-body-large flex h-fit w-full flex-row items-center justify-between whitespace-nowrap bg-background-blur px-5 py-3.75 font-normal leading-6 tracking-[0.03125rem]">
      <CardContent>{courseName}</CardContent>
      <CardContent className="flex items-center gap-1.25">
