            ...
            <div id="talkwithus" className="my-8">
                ...
                <div id="emails">
                    <div id="collabs" className="my-4">
                        ...
                        <a href="mailto:eventi@polinetwork.org" className="text-sm">eventi@polinetwork.org</a>
                    </div>
                    <div id="requests">
                        <p className="text-md text-gray-600">Per domande e richieste</p>
                        <a href="mailto:direttivo@polinetwork.org" className="text-sm">direttivo@polinetwork.org</a>
                    </div>
                </div>
            </div>
