    ...
    return (
        <section className="min-h-screen w-full">
            <div className="mx-auto flex w-full max-w-350 flex-col gap-35 px-12 pt-58 pb-18">
                <GuideHero />
                <GuideContent
                    title={guidesInfo.title}
                    description={guidesInfo.description}
                    guides={guidesInfo.guides}
                />
            </div>
            ...
            <div className="mx-auto flex w-full max-w-350 flex-col px-12 pb-18">
                <GuideContent
                    title={guidesGeneral.title}
                    description={guidesGeneral.description}
                    guides={guidesGeneral.guides}
                />
            </div>
        </section>
    )
